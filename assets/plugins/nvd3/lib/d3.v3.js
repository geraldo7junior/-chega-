d3 = function() {
  ...
  var d3_time_days = [ "Domingo", "Segunda", "Terça", "Quarta", "Quinta", "Sexta", "Sábado" ], d3_time_dayAbbreviations = [ "Dom", "Seg", "Ter", "Qua", "Qui", "Sex", "Sab" ], d3_time_months = [ "Janeiro", "Fevereiro", "Março", "Abril", "Maio", "Junho", "Julho", "Agosto", "Setembro", "Outubro", "Novembro", "Dezembro" ], d3_time_monthAbbreviations = [ "Jan", "Fev", "Mar", "Abr", "Mai", "Jun", "Jul", "Ago", "Set", "Out", "Nov", "Dez" ];
